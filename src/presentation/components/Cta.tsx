    ...
    <section>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="relative">
          {/* Background */}
          <div className="absolute inset-0 bg-gradient-to-br from-slate-900 to-slate-800 rounded-3xl -mx-20 -z-10 overflow-hidden" aria-hidden="true">
            {/* Illustration */}
          ...
          <div className="py-12 md:py-20 -mx-20 px-20">
            <div className="md:flex justify-between items-center text-center md:text-left">
              ...
              <div className="md:max-w-[640px]">
                {/* Copy */}
                <h2 className="h2 font-hkgrotesk font-extrabold text-slate-100 mb-6" data-aos="fade-right">
                  Claim your POW Card{' '}
                  <span className="font-permanent-marker text-yellow-400 font-normal whitespace-nowrap">
                    today{' '}
                ...
                <p className="text-slate-400" data-aos="fade-right" data-aos-delay="100">
                  Experience Web3-powered loyalty programs, event ticketing, and more.
                </p>
              </div>

              {/* Right content */}
              <div className="mt-6 md:ml-5 md:mt-0" data-aos="fade-left" data-aos-duration="900">
                <Link className="btn text-white bg-blue-500 hover:bg-blue-600 group shadow-sm" to="/claim">
                  Get Started{' '}
